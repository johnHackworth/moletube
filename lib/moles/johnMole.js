...
(function() {
  var mole = function(options) {
    ...
    this.desires = new window.moletube.models.DesireManager();
  ...
  mole.prototype = {
    ...
    buyProduct: function(productType) {
      this.log('bought some ' + productType);
      var happy = 10 * this.desires.getHappinessFromProduct(productType) / 100;
