...
(function() {
  ...
  mole.prototype = {
    ...
    drawPos: function() {
      ...
      if (this.selectedDotView) {
        this.selectedDotView.position.x = this.stage.viewport.getX(this.pos.x - this.selectedDotView.width / 2);
        this.selectedDotView.position.y = this.stage.viewport.getY(this.pos.y - this.view.height - 20);
      }
    ...
    walkAround: function() {
      if (this.path.length === 0 && Math.random() > 0.99) {
        this.destination = {
    ...
    animate: function() {
      ...
      if (this.visibleTileTypes.indexOf(this.currentBlock.type) < 0) {
    ...
    select: function() {
      this.selectedDotView = PIXI.Sprite.fromImage('assets/yellowFlag.png');
      this.stage.addVisualEntity(this.selectedDotView);
    },
    unselect: function() {
      this.stage.removeView(this.selectedDotView);
      delete this.selectedDotView;
    },
