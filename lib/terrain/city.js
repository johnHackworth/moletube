...
(function() {
  ...
  city.prototype = {
    ...
    init: function() {
      ...
      this.cityGenerator.generateStreets()
      this.cityGenerator.generateZones();
    ...
    setNight: function() {
      for(var i in this.blocks) {
        if(this.blocks[i].building) {
          this.blocks[i].building.view.tint = 0x999999;
        }
      }
    },
    setDay: function() {
      for(var i in this.blocks) {
        if(this.blocks[i].building) {
          this.blocks[i].building.view.tint = 0xFFFFFF;
        }
      }
    },
    hideLines: function() {
