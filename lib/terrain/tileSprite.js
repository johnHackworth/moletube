...
(function() {
  ...
  tile.prototype = {
    ...
    drawView: function() {
      var self = this;
      this.origX = this.origX - Math.floor(this.width);
      this.origY = this.origY - Math.floor(this.height);
      var x = this.origX;
      var y = this.origY;
      var w = this.width;
      var h = this.height;
      ...
      this.origY = this.origY + this.height;
    ...
    tick: function(counter) {
      ...
      if (this.type === 's' && !this.tinted && Math.random() < 0.001) {
        this.tinted = 50;
    ...
    showProjectDemo: function() {
      ...
      if (!this.allowsBuilding(this.projectDemo)) {
