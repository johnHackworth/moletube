...
(function() {
  ...
  tile.prototype = {
    ...
    addText: function() {
      ...
      this.text = this.stage.addText(this.block.blockNumber.x + '-' +
        this.block.blockNumber.y, {
          x: this.view.position.x + 30,
          y: this.view.position.y + 10,
          fontSize: '10px',
          color: '#FAFAFA'
        }, []);
    ...
    tick: function(counter) {
      ...
      if (this.text) {
        this.text.x = this.view.x + 40;
        this.text.y = this.view.y + 20;
      }
      if (this.viewSquare) {
