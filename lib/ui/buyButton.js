...
(function() {
  ...
  buy.prototype = {
    ...
    init: function() {
      this.textures = {
        normal: new PIXI.Texture.fromImage('assets/buttons/buy.png'),
        hover: new PIXI.Texture.fromImage('assets/buttons/buy.png')
      };
      this.view = new PIXI.Sprite.fromImage('assets/buttons/buy.png');
  ...
  window.moletube.models.BuyButton = buy;
})();