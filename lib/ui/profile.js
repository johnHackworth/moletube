...
(function() {
  ...
  profile.prototype = {
    ...
    init: function() {
      ...
      this.fullProfileButton = this.stage.addText('full profile', {
        x: this.x + this.width - 100,
        y: this.y + 50,
        fontSize: '20px',
        color: '#333333'
      }, this.destroyables);
      this.fullProfileButton.setInteractive(true);
      this.fullProfileButton.click = this.clickFull.bind(this);
    ...
    clickFull: function() {
      this.stage.overlayManager.showMoleProfile(this.profiled);
    },
