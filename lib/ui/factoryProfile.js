...
(function() {
  ...
  profile.prototype = {
    ...
    init: function() {
      ...
      this.background.lineTo(x + this.width, y);
      this.background.lineTo(x + this.width, y + this.height);
    ...
    showOwner: function() {
      this.pictureOwner = new PIXI.Sprite.fromImage(this.profiled.owner.imageView);
      this.pictureOwner.x = this.x + 150;
      this.pictureOwner.y = this.y;
      this.pictureOwner.viewType = 'text';
      // this.picture.setTexture(this.profiled.textures.big);
      this.stage.addVisualEntity(this.pictureOwner);
