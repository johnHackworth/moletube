...
(function() {
  ...
  baseBuilding.prototype = {
    ...
    addRevenue: function(revenue) {
      this.totalRevenue += revenue;
      this.produtRevenue += revenue;
    },
    sellProductTo: function(destination, price) {
      if (this.storage) {
    ...
    payWages: function(destination, wage) {
      this.owner.money -= wage;
      destination.money += wage;
      this.totalCosts += wage;
      this.wagesCosts += wage;
    }
  };
